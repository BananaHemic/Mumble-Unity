...
namespace Mumble
{
    ...
    {
        /*
        internal readonly MumbleProtocol Owner;
        ...
        public Channel(MumbleProtocol owner, uint id, string name, uint parent)
        {
            Owner = owner;
            Id = id;
            Name = name;
        ...
        public void SendMessage(string[] message, bool recursive)
        {
            ...
            Owner.Connection.SendControl<TextMessage>(MessageType.TextMessage, msg);
        }
        ...
        public void Join()
        {
            ...
            Owner.Connection.SendControl<UserState>(MessageType.UserState, state);
        }
